...
import { Target, Sword, Plus, Crown, Shield, User, Zap, Flame, Star, Activity, Trash2, Pencil, GripVertical, X, Settings, Heart, Users } from 'lucide-react'
...
export default function ElysiumPage() {
    ...
    const handleDragEnd = (event) => {
        ...
        if (over && active.id !== over.id) {
            ...
            // Reordering persistence is handled by the order in userStats.goals
        }
    }
                ...
                <header className="dashboard-header" style={{ marginBottom: '32px', paddingBottom: '16px' }}>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                        ...
                        <button
                            ...
                            style={{
                                background: 'var(--yellow)', color: 'black', border: '4px solid black',
                                padding: '12px 24px', fontWeight: '900', boxShadow: '8px 8px 0px black',
                                height: 'fit-content', width: 'fit-content',
                                flexShrink: 0, whiteSpace: 'nowrap'
                            }}
                        >
                            <Plus size={20} strokeWidth={4} /> NEW QUEST
                        </button>
                    </div>
                </header>
